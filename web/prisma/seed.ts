...
async function seed() {
	...
	const kodyImages = await promiseHash({
		moonhubUser: img({ filepath: './tests/fixtures/images/user/moonhub.png' }),
		cuteKoala: img({
			alt_text: 'an adorable koala cartoon illustration',
			filepath: './tests/fixtures/images/kody-notes/cute-koala.png',
		}),
		koalaEating: img({
			alt_text: 'a cartoon illustration of a koala in a tree eating',
			filepath: './tests/fixtures/images/kody-notes/koala-eating.png',
		}),
		koalaCuddle: img({
			alt_text: 'a cartoon illustration of koalas cuddling',
			filepath: './tests/fixtures/images/kody-notes/koala-cuddle.png',
		}),
		mountain: img({
			alt_text: 'a beautiful mountain covered in snow',
			filepath: './tests/fixtures/images/kody-notes/mountain.png',
		}),
		koalaCoder: img({
			alt_text: 'a koala coding at the computer',
		...
		koalaSoccer: img({
			alt_text: 'a cute cartoon koala kicking a soccer ball on a soccer field ',
